...
if p2avail == 'y': #|| p2avail == "Y" Code if user enters 'Y' or 'y':
        ...
        agetagp1 = "" #Mentions whether p2 is a child, teenager or adult or not yet born :D
        agetag_calc(agetagp2)
        ...
        print("--------------------------------------------------------------------------------------------------------")
        print("%s who is a %s is %d year%c %d month%c and %d day%c old\n", p1name, agetagp1[1], p1year, p1yearis, p1month, p1monthis, p1day, p1dayis)
        print("%s who is a %s is %d year%c %d month%c and %d day%c old\n", p2name, agetagp2[2], p2year, p2yearis, p2month, p2monthis, p2day, p2dayis)
...
elif :(p2avail == 'n' || p2avail == 'N') #Code if user enters 'N' or 'n'
    print("--------------------------------------------------------------------------------------------------------")
    print("%s who is a %s is %d year%c %d month%c and %d day%c old\n\n", p1name, agetagp1[1], p1year, p1yearis, p1month, p1monthis, p1day, p1dayis)
...
if int(age) > 1 :   yearis = ("s")
else : yearis = ""
print(age)
print("%s is %d year%s old" % (name, int(age), yearis))
"""
